...
## Set up
```{r, message = FALSE}
#string must be stored as factor to run ANOVA
library(tidyverse)
...
#assumptions: populations normally distributed, variance equal, observations are independent
#can fail checks due to small sample size
#lm can still be used on categorical data; R will automatically switch it to anova
